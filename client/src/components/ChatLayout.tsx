...
- すでに他のキャラクターが言った内容の単なる言い換えは避け、必ず「新しい視点」「具体例」「別案」のいずれかを1つ以上追加してください。
- 返答の中で、必ず他のキャラクターの誰か1人の発言に対して具体的にコメントしたり、質問したりしてください。
- すでにほぼ同じ結論が共有されている場合は、同意を繰り返すのではなく一段先の話題に進めてください。
`;
